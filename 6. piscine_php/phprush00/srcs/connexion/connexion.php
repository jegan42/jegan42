...
if ($_SESSION['logged_on_user'] == "admin")
{
	...
	else if ($_SESSION['flag_log'] == "OK" && $_SESSION['mail'] != NULL)
	{
		echo "<p id='inscription-ok'>\nKpop-Shop vous salue, ".$_SESSION['logged_on_user']."!\n</p>";
		echo "<p>Allez faire un kpop-tour dans notre <a href=../boutique.php>boutique</a>\n</p>";
		echo "<p>Ou amusez vous avec nos kpop-goodies à <a href=../../index.php>l'accueil</a>\n</p>";
		$_SESSION['flag_log'] = "";
	}
