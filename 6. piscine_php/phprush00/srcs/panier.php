...
{
		$total = 0;
		echo "<table id='tab-admin-product'>";
		echo "<tr><th>Nom du produit</th><th>Quantite</th><th>Prix</th><tr/>";
		...
		{
			echo "<td><form action='boutique.php'><input type='submit' name='del' value='Retour Boutique' /></form></td>";
			echo "<td><form action='del_panier.php'><input type='submit' name='del' value='Vider le panier' /></form></td>";
...
if ($total == 0 && $_SESSION['nb_articles'])
